...
class Ui_dashboardDialog(object):
    def setupUi(self, dashboardDialog):
        ...
        dashboardDialog.resize(770, 730)
        ...
        self.btn_pauseSwarmBehavior = QtWidgets.QPushButton(dashboardDialog)
        self.btn_pauseSwarmBehavior.setObjectName("btn_pauseSwarmBehavior")
        self.gridLayout.addWidget(self.btn_pauseSwarmBehavior, 8, 0, 1, 1)
        self.btn_resumeSwarmBehavior = QtWidgets.QPushButton(dashboardDialog)
        self.btn_resumeSwarmBehavior.setObjectName("btn_resumeSwarmBehavior")
        self.gridLayout.addWidget(self.btn_resumeSwarmBehavior, 8, 1, 1, 1)
    ...
    def retranslateUi(self, dashboardDialog):
        ...
        self.combo_swarmBehavior.setItemText(3, _translate("dashboardDialog", "PN Interceptor"))
        self.combo_swarmBehavior.setItemText(4, _translate("dashboardDialog", "Eager Altitude Sort"))
        self.combo_swarmBehavior.setItemText(5, _translate("dashboardDialog", "Lazy Altitude Sort"))
        self.combo_swarmBehavior.setItemText(6, _translate("dashboardDialog", "Independent Transit"))
        self.combo_swarmBehavior.setItemText(7, _translate("dashboardDialog", "Sequence Land"))
        ...
        self.combo_swarmState.setItemText(4, _translate("dashboardDialog", "Landing"))
